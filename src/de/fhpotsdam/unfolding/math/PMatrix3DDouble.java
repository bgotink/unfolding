...
//  }
  ...
  public PVector mult(PVector source, PVector target) {
    ...
    target.x = (float)(m00*source.x + m01*source.y + m02*source.z + m03);
    target.y = (float)(m10*source.x + m11*source.y + m12*source.z + m13);
    target.z = (float)(m20*source.x + m21*source.y + m22*source.z + m23);
  ...
  public void print() {
    ...
    */
    ...
    System.out.println(PApplet.nfs((float)m00, digits, 4) + " " +
                       ...
                       PApplet.nfs((float)m03, digits, 4));

    System.out.println(PApplet.nfs((float)m10, digits, 4) + " " +
                       PApplet.nfs((float)m11, digits, 4) + " " +
                       PApplet.nfs((float)m12, digits, 4) + " " +
                       PApplet.nfs((float)m13, digits, 4));

    System.out.println(PApplet.nfs((float)m20, digits, 4) + " " +
                       PApplet.nfs((float)m21, digits, 4) + " " +
                       PApplet.nfs((float)m22, digits, 4) + " " +
                       PApplet.nfs((float)m23, digits, 4));

    System.out.println(PApplet.nfs((float)m30, digits, 4) + " " +
                       PApplet.nfs((float)m31, digits, 4) + " " +
                       PApplet.nfs((float)m32, digits, 4) + " " +
                       PApplet.nfs((float)m33, digits, 4));
